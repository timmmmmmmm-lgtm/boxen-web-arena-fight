      ...
      <div className="container mx-auto px-4 py-8">
        <Tabs defaultValue="news" className="w-full">
          <TabsList className="w-full justify-start mb-6 bg-sidebar">
            <TabsTrigger value="news">Neueste Nachrichten</TabsTrigger>
            <TabsTrigger value="events">Kommende Events</TabsTrigger>
            <TabsTrigger value="rankings">Ranglisten</TabsTrigger>
          </TabsList>
